...
const CartItemRow = React.memo(function CartItemRow({
  ...
  return (
    <div className="flex gap-4 items-center pb-6 border-b border-[#78716C]/10">
        ...
        <div className="flex items-center gap-3 mt-3">
          <div className="flex items-center border border-[#78716C]/30 bg-[#fbf9f6]">
            <button 
              ...
              className="px-2 py-1 text-[#1C1917] hover:bg-[#efeeeb] transition-colors"
              aria-label="Disminuir cantidad"
            >
              <Minus size={12} />
            </button>
            <span className="px-3 text-xs font-semibold text-[#1C1917]">{item.quantity}</span>
            <button 
          ...
          <button 
            ...
            className="text-[#78716C] hover:text-[#7C0A12] transition-colors ml-auto"
      ...
      <div className="text-right shrink-0">
        <span className="font-heading text-sm font-semibold text-[#1C1917]">${item.product.price * item.quantity}</span>
        {item.quantity > 1 ? (
